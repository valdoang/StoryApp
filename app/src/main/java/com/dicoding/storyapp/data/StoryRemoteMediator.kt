...
class StoryRemoteMediator(
    ...
    private val loginPreference: LoginPreference) : RemoteMediator<Int, ListStoryItem>() {
    ...
    override suspend fun load(
        ...
        try{
            val token = loginPreference.getToken().first()
            val responseData = apiService.getListStories("Bearer $token", state.config.pageSize, page)
            ...
            database.withTransaction {
                ...
                responseData.listStory.forEach { story ->
                    ...
                    database.storyDao().insertStory(item)
                }
